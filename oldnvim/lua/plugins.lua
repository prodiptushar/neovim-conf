...
return require("packer").startup(function(use)
 ...
 --- Customo Plugin Area ---
  ...
  -- use { "https://github.com/tpope/vim-unimpaired.git"}
--   use { "https://github.com/neoclide/coc.nvim.git" }
   ...
   use {"https://github.com/vim-syntastic/syntastic.git"}
   use{ "kevinhwang91/nvim-bqf" }
   use {"szw/vim-maximizer"}
   use { "https://github.com/easymotion/vim-easymotion.git" }
   use { "https://github.com/phaazon/hop.nvim" }
   use { "https://github.com/mattn/emmet-vim.git" }
 -- use { "justinmk/vim-sneak" }
 -- use {"https://github.com/phaazon/hop.nvim.git"}
